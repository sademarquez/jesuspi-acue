document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            // --- INICIO DE LA CORRECCIÓN DEL CIERRE DEL MENÚ ---
            // Cerrar menú móvil si está abierto y el enlace clickeado es un descendiente del menú móvil
            if (mobileMenu && mobileMenu.classList.contains('active') && mobileMenu.contains(this)) { 
                mobileMenu.classList.remove('active');
                // Restaurar los iconos al cerrar el menú
                const hamburgerIcon = mobileMenuButton.querySelector('.hamburger-icon');
                const closeIcon = mobileMenuButton.querySelector('.close-icon');
                if (hamburgerIcon) hamburgerIcon.classList.remove('hidden');
                if (closeIcon) closeIcon.classList.add('hidden');
            }
            // --- FIN DE LA CORRECCIÓN DEL CIERRE DEL MENÚ ---
        });
    });
});
